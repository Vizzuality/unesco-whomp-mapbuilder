...
export const layersPanelTranslations = {
  ...
  fr: {
    ...
    layers: 'Couches',
    description:
      'Sélectionnez des ensembles de données de différentes catégories que vous souhaitez visualiser et ajouter à la carte. Les métadonnées et un tutoriel sont également disponible <a href="https://whc.unesco.org/uploads/activities/documents/activity-1142-19.pdf">ici</a>.',
